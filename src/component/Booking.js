                ...
                <form className=' m-4 w-3/4 shadow-md bg-clip-border rounded-xl ' onSubmit={handleSubmit}>
                    <div className='m-2'>
                        <label className='block text-gray-700 text-lg font-bold mb-2'>
                            ...
                            <input className=' m-2 block w-1/2 rounded-md  py-1.5 pl-7 pr-20  ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6' type="text" value={firstName} onChange={(e) => setFirstName(e.target.value)} />
                        </label>
                    </div>
                    <br />
                    <div className='m-2'>
                        <label className='block text-gray-700 text-lg font-bold mb-2'>
                            <div className='m-2'>First Name:</div>
                            <input className=' m-2 block w-1/2 rounded-md  py-1.5 pl-7 pr-20  ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6' type="text" value={lastName} onChange={(e) => setLastName(e.target.value)} />
                        </label>
                    </div>
                    <br />
                    <div className='m-2'>
                        <label className='block text-gray-700 text-lg font-bold mb-2'>
                            ...
                            <input className='border-spacing-3 m-2' type="date" value={bookingDate} onChange={(e) => setBookingDate(e.target.value)} />
                        </label>
                    </div>
                    <div className='m-2'>
                        <label className='m-2'>
